...
function getVisualizedMesh( linearData, year, countries ){
	...
	uniforms = {
		...
		texture:   { type: "t", value: 0, texture: THREE.ImageUtils.loadTexture( "app/globe/images/particleA.png" ) },
	};
	...
	var particleGraphic = THREE.ImageUtils.loadTexture("app/globe/images/map_mask.png");
...
function selectVisualization( linearData, year, countries){
	...
	console.log("Highlight Country on Viz");
	...
	//	clear children
	// console.log("Length " + visualizationMesh.children.length);
	...
	// console.log("Camera Move: " + mesh.affectedCountries );
	//highlightCountry( [ mesh.affectedCountries, countrysel_buffer], highlightCountry );
	highlightCountry( mesh.affectedCountries, highlightCountry );
